...
does not support vision. Disabling use_screenshot."""
    ...
    def _get_maxes(self):
        maxes = [self.flags.max_prompt_tokens, self.chat_model_args.max_input_tokens]

        # If max_input_tokens isn't set, derive it from max_total - max_new
        if self.chat_model_args.max_input_tokens is None and self.chat_model_args.max_total_tokens is not None:
            max_new = self.chat_model_args.max_new_tokens or 0
            maxes.append(self.chat_model_args.max_total_tokens - max_new)
